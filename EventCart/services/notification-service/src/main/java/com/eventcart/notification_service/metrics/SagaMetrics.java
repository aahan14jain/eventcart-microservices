package com.eventcart.notification_service.metrics;
...
public class SagaMetrics {
    ...
    public static final String STEP_ORDER_CONFIRMED = "notification.order_confirmed";
    public static final String STEP_ORDER_FAILED = "notification.order_failed";
